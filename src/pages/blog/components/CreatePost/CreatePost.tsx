...
export default function CreatePost() {
  const [addPostMutation, addPostMutationResult] = useAddPostMutation()
  const [formData, setFormData] = useState<Omit<IPost, 'id'> | IPost>(initialState)

  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault()
    const result = await addPostMutation(formData)
